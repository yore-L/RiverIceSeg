...
from rivericeseg.models.UNet_self import UNet
...
weights_path = 'model_weights/Unet/{}'.format(weights_name)
test_weights_name = 'last-v1'
log_name = 'river_ice/unt{}'.format(weights_name)
monitor = 'val_mIoU'
monitor_mode = 'max'
save_top_k = 1
save_last = True
check_val_every_n_epoch = 1
pretrained_ckpt_path = 'model_weights/Unet/river_ice/river_ice-v1.ckpt'    # 预训练模型权重的路径
