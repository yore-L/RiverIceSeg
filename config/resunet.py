...
from rivericeseg.losses.basic_loss import CombinedBinaryLoss
# from rivericeseg.losses import *
from rivericeseg.datasets.dataset import *
from rivericeseg.models.ResUnet import ResUnet
...
weights_path = 'model_weights/ResUnet/{}'.format(weights_name)
test_weights_name = 'last'
log_name = 'river_ice/RsUnt{}'.format(weights_name)
monitor = 'val_mIoU'
monitor_mode = 'max'
save_top_k = 1
save_last = True
...
# 定义网络
net = ResUnet(num_classes=2, in_channel=3)
